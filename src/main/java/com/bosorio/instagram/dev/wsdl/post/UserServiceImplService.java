 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://services.dev.instagram.bosorio.org/", wsdlLocation = "http://localhost:8080/instagram-dev-backend/UserServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private static final QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://services.dev.instagram.bosorio.org/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/instagram-dev-backend/UserServiceImpl?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://services.dev.instagram.bosorio.org/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.dev.instagram.bosorio.org/", "UserServiceImplPort"), UserService.class, features);
    }
