 ...
 *         <element name="followers" type="{http://services.dev.instagram.bosorio.org/}user" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="following" type="{http://services.dev.instagram.bosorio.org/}user" maxOccurs="unbounded" minOccurs="0"/>
...
public class User {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the following property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
